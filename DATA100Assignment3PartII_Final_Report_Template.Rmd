...
This report explores how climate change awareness, hurricane strengths in the oceans, and ice extents relate to each other by year. Using three cleaned data sets on climate change awareness (climate_awareness), hurricane strength in both the Atlantic and North Pacific basins (cyclone_data), and yearly ice extent for the Arctic and the Antarctic poles (ice_extent), we join the data by country to form a single analysis table.


By combing global climate-awareness estimates with 
