...
analysis_data |>
  ...
  labs(x = "Share who know 'a lot' about climate change",
...
summary_table <- analysis_data |>
  ...
  summarise(
    ...
    mean_cases_per_capita = mean(cases_per_capita, na.rm = TRUE))

kable(summary_table,
      digits = 2,
      caption = "Summary statistics by continent for happiness, climate awareness, and
...
analysis_data |>
  ...
  ggplot(aes(x = cases_per_capita, y = ladder_score, colour = continent)) +
  geom_point(alpha = 0.7) +
  geom_smooth(se = FALSE) +
  scale_x_log10(labels = label_number_si()) +
  labs(x = "COVID-19 cases per capita (log scale)",
       y = "Happiness (ladder score, 0–10)",
       colour = "Continent")
```
